...
\newcommand{\lettrineF}[1]{\lettrine[lines=3, slope=0pt, nindent=0pt, findent=2pt]{F}{#1}}
...
\newcommand{\lettrineO}[1]{\lettrine[lines=3, findent=0pt, nindent=6pt, slope=0pt]{O}{#1}}
