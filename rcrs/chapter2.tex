...
\index{fascism}\index{Popular Front}\index{bourgeoisie}\index{working class}
...
As late as January 1936, the Comintern\index{Comintern} said of him:

\begin{quotation}\index{Inprecor@\emph{Inprecor}}
...
\index{Diaz, Jose@Díaz, José}
The last phrase is an admission that repression will come from the direction of Azaña himself. And it did come, as José Díaz, Secretary of the Communist Party\index{Communist Party of Spain}, was compelled to admit just before the civil war broke out:
...
\index{political repression}\indexUGT\indexCNT
...
\indexMAzana\index{war crimes}\index{disloyalty}
...
\indexMAzana\index{Constitution of Spain}
...
\index{reprivatization}{\indexMAzana}
...
\indexFFranco\index{Morocco}\index{Madrid}\index{Ministries!Navy}\index{Giral, Jose@Giral, José}\index{Coup of July 1936}
...
\index{armament of the working class!refusal to arm}
This incredibly dishonest note was issued to justify the government’s refusal to arm the workers, as the trade unions had requested. But this was not all. At \textls[40]{5:20} and again at \textls[40]{7:20} \textsc{pm}, the government issued similar notes, the last declaring that ``in Seville \dots\ there were acts of rebellion by the military elements that were repelled by the forces in the service of the government.'' Seville had then been in the hands of Queipo de~Llano for most of the day.

\indexMAzana\indexDBarrio\index{bourgeois--Stalinist bloc}\index{Coup of July 1936}
...
\index{Coup of July 1936}\index{strikes!general strikes}\indexMAzana\indexJGiral
...
\index{socialism or barbarism}\index{bourgeois republic}
